...
| onDownload           | func                            |                                                              | true     | Callback fired when downloaded the file.<br />**Signature:**<br/>`function(id: string) => void`<br/>*id:* The unique id of the file, but if `fileKey`is not null/undefined, here you will get the `fileKey` instead of the `id`. |
| onRemove             | func                            |                                                              | true     | Callback fired when removed the file.<br />**Signature:**<br/>`function(id: string) => void`<br/>*id:* The unique id of the removing file, but if `fileKey`is not null/undefined, here you will get the `fileKey` instead of the `id`. |
